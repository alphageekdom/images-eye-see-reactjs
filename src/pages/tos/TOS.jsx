  ...
  return (
    <section id='tos'>
      ...
      <div className='container tos__container'>
        ...
        <div className='tos__main-title'>
          <h2>Last Updated: 2023-03-27</h2>
        </div>
        <div className='tos__content'>
          {/* START ARTICLE 1 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>1. Introduction</h3>
            <p className='tos__content-info'>
              Welcome to Images Eye See LLC (“Company”, “we”, “our”, “us”)!
              ...
              (together or individually “Service”) operated by Images Eye See
              LLC. Our Privacy Policy also governs your use of our Service and
          ...
          {/* START ARTICLE 2 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>2. Communications</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 3 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>3. Purchases</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 4 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>
          ...
          {/* START ARTICLE 5 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>5. Refunds</h3>
            <p className='tos__content-info'>
              All sales for all services (offerings) and products are final. No
              Refunds will be given. 48hrs email prior to appointment must be
              given in order to reschedule service purchased.
            </p>
          </article>
          {/* END ARTICLE 5 */}
          {/* START ARTICLE 6 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>6. Content</h3>
            <p className='tos__content-info'>
              Content found on or through this Service are the property of
              Images Eye See LLC or used with permission. You may not
          ...
          {/* START ARTICLE 7 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>7. Prohibited Uses</h3>
            <div className='tos__content-info'>
              <h4 className='tos__content-subtitle'>
                You may use Service only for lawful purposes and in accordance
                with Terms. You agree not to use Service:
              </h4>
              <ul className='tos__content-list'>
                <li>
                  <p>
          ...
          {/* START ARTICLE 8 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>8. Analytics</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 9 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>9. No Use By Minors</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 10 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>10. Intellectual Property</h3>
            <p className='tos__content-info'>
              Service and its original content (excluding Content provided by
              users), features and functionality are and will remain the
              exclusive property of Images Eye See LLC and its licensors.
              ...
              consent of Images Eye See LLC.
            </p>
          </article>
          {/* END ARTICLE 10 */}
          {/* START ARTICLE 11 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>11. Copyright Policy</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 14 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>14. Links To Other Web Sites</h3>
            <p className='tos__content-info'>
              Our Service may contain links to third party web sites or services
              that are not owned or controlled by Images Eye See LLC. Images Eye
              See LLC has no control over, and assumes no responsibility for the
              ...
              template for a website, blog, e-commerce store or app. YOU
          ...
          {/* START ARTICLE 15 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>15. Disclaimer Of Warranty</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 16 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>16. Limitation Of Liability</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 17 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>17. Termination</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 18 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>18. Governing Law</h3>
            <p className='tos__content-info'>
              These Terms shall be governed and construed in accordance with the
              laws of America, which governing law applies to agreement without
          ...
          {/* START ARTICLE 19 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>19. Changes To Service</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 20 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>20. Amendments To Terms</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 21 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>21. Waiver And Severability</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 22 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>22. Acknowledgement</h3>
            <p className='tos__content-info'>
          ...
          {/* START ARTICLE 23 */}
          <article data-aos='fade-up'>
            <h3 className='tos__content-title'>23. Contact Us</h3>
            <p className='tos__content-info'>
              ...
              by PolicyMaker.io on 2023-03-27.
            </p>
          </article>
          {/* END ARTICLE 23 */}
        </div>
